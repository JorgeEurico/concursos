...
<div class="wrapper">
    ...
    <div class="card">
        ...
        <div class="card-block">
            <form action="{{route('configuracoes.atualizarRole')}}" method="POST">
                @csrf
                <input type="hidden" name="user-id" value="{{$usuario->id}}">
                <div class="mb-3">
                     <label for="name" class="form-label">Nome</label>
                    <input type="text" class="form-control" id="name" value="{{ $usuario->name }}" readonly>
                </div>
                <div class="mb-3">
