...
<div class="card">
    ...
    <div class="card-block">
        <form action="{{ route('concursos.salvarConcurso') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                <label for="nomeConcurso" class="form-control-label">Descrição</label>
                <input type="text" class="form-control" id="nomeConcurso" name="descricao" placeholder="Insira o tipo de concurso">
            </div>
            <div class="form-group">
